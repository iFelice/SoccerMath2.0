"""
backtest_experiment.py — Esperimento controllato: SoccerMath ha un edge storico su Serie A?

Non tocca app.py, config.py, ne' i motori Poisson/Elo/Dixon-Coles esistenti.
Replica la STESSA logica di run_historical_backtest() (walk-forward, no leakage)
ma:
...
DB = "/home/claude/SoccerMath2.0/SoccerMath/database"
STAKE = 10.0
...
def load_serie_a():
    files = {
        "2022/23": f"{DB}/SerieA_2022.csv",
        "2023/24": f"{DB}/SerieA_2023.csv",
        "2024/25": f"{DB}/SerieA_2024.csv",
        "2025/26": f"{DB}/SerieA_2025.csv",
        "2026/27": f"{DB}/SerieA_Live.csv",
    }
    dfs = []
